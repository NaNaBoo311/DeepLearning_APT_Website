...
import { Image, Type, Layers, Users } from 'lucide-react';
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-white rounded-3xl p-8 shadow-sm border border-slate-100 mb-8 mt-4 relative overflow-hidden">
        ...
        <div className="flex flex-wrap gap-6 text-sm text-slate-600 relative z-10">
        ...
        {tabs.map((tab) => {
          ...
          return (
            <button
              ...
              className={`flex items-center gap-2 px-6 py-3 rounded-xl font-medium text-sm transition-all duration-200 whitespace-nowrap ${isActive
